<template>
    <div style="margin: auto; margin-top: 10vh;margin-right:15vh" >         
        <div >
            <h1>View All </h1>  
            <p class="button3">Export Excel</p>
            <!-- <b-button class="bb" v-on:click="onTestSaveFile()">export excel</b-button> -->
            <b-button class="button2" v-on:click="onTestSaveFile()">  <b-img :src="require('../photo/ee.png')" 
            class="img-body2"></b-img></b-button>
